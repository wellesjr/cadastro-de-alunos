                            ...
                            <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                                <div class="card-body">
                                    <a href="" <?php echo base_url('') ?>" class="navbar-brand d-flex align-items-center mb-3">
                                        ...
                                        <!--logo End-->
                                        <h4 class="logo-title ms-3">Cadastro de Alunos</h4>
                                    </a>
                                    <h2 class="mb-2 text-center"></h2>
                                    <p class="text-center">Realize seu login</p>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            echo form_input('email_usuario', set_value('email_usuario'), array('class' => 'form-control col-md-12', 'placeholder' => ' ', 'required' => ''))
                                            ?>
                                        </div>
                                        <div class="col-lg-12">
                                            <?php
                                            echo form_label('Senha', 'senha');
                                            echo form_password('senha', '', array('class' => 'form-control col-md-12', 'placeholder' => '', 'required' => ''))
                                            ?>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-center">
                                        <?php
                                        echo form_submit('Entrar', 'Entrar', array('class' => 'btn btn-primary center'));
                                        echo form_close(); ?>
                                    </div>
