...
(() => {
  function e(e, t, n, o) {
    ...
    window.requestAnimationFrame(function r(f) {
      ...
      var v = f - i;
      o
        ? ((e.style.height = p * v + "px"),
          (e.style.paddingTop = c * v + "px"),
          (e.style.paddingBottom = y * v + "px"),
          (e.style.marginTop = m * v + "px"),
          (e.style.marginBottom = g * v + "px"))
        : ((e.style.height = l - p * v + "px"),
          (e.style.paddingTop = a - c * v + "px"),
          (e.style.paddingBottom = u - y * v + "px"),
          (e.style.marginTop = s - m * v + "px"),
          (e.style.marginBottom = d - g * v + "px")),
        v >= t
          ? ((e.style.height = ""),
            (e.style.paddingTop = ""),
    ...
    window.innerWidth < 1200 &&
      ...
      e.forEach(function (e) {
        e.querySelector(".menu-link").addEventListener("click", function (t) {
          t.preventDefault(),
            e.querySelector(".submenu").classList.toggle("active");
        });
      }),
      document.querySelectorAll(".submenu-item.has-sub").forEach(function (e) {
        e.querySelector(".submenu-link").addEventListener(
          "click",
          function (t) {
            t.preventDefault(),
              e.querySelector(".subsubmenu").classList.toggle("active");
          }
        );
      })),
      window.innerWidth > 1200 &&
