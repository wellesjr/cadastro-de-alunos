 ...
 * Args:
 *   e: the document
 *   t: the current DOM element
 *   n: The number of elements to return.
 */
/**
 * The function checks if the argument passed in is an array.
 * @param e - The element to be checked.
 * @param t - The element to be added to the array.
 * @param n - The array that we're checking.
 */
!(function (e, t) {
  "use strict";
  ...
  /* Checking if the argument passed in is an array. */
  function S(e) {
          ...
          if (11 !== x && (d = Z.exec(e)))
            if ((a = d[1])) {
              ...
              if (
                ...
                return I.apply(r, t.getElementsByClassName(a)), r;
            }
          if (
            n.qsa &&
            !D[e + " "] &&
        ...
        return (
          ...
          ce(function (a, s, o, l) {
            var c,
              ...
              v = n ? (i || (a ? e : h || r) ? [] : s) : g;
            if ((n && n(g, v, o, l), r))
              for (c = Se(v, f), r(c, [], o, l), u = c.length; u--; )
                (d = c[u]) && (v[f[u]] = !(g[f[u]] = d));
            if (a) {
              if (i || e) {
                if (i) {
    ...
    if (((n = n || k), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          x.merge(
            this,
            x.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : g, !0)
          ),
      ...
      return (
        (i = g.getElementById(r[2])) && ((this[0] = i), (this.length = 1)), this
      );
    }
    return e.nodeType
      ...
      function (e, t) {
        x.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (I[e] || x.uniqueSort(i), P.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
        ...
        var n = [
          ...
          i = {
            ...
            then: function (t, r, i) {
              ...
              return x
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, h(i) ? i : N, e.notifyWith)),
    ...
    x.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = K.get(a)), 1 === a.nodeType && !U.get(a, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
  ...
  function ue(e, t) {
    for (var n, r, i = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]).style &&
        ...
        t
          ? ("none" === n &&
              ((i[a] = U.get(r, "display") || null),
              i[a] || (r.style.display = "")),
            "" === r.style.display && se(r) && (i[a] = ce(r)))
          : "none" !== n && ((i[a] = "none"), U.set(r, "display", n)));
  ...
  function we(e, t, n, r, i) {
    ...
    for (d.textContent = "", f = 0; (a = p[f++]); )
      if (r && x.inArray(a, r) > -1) i && i.push(a);
        ...
        ((c = ie(a)), (s = ve(d.appendChild(a), "script")), c && ye(s), n)
      )
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                (r = n(this, t)),
                this[t](),
                s !== (a = U.get(this, t)) || r ? U.set(this, t, !1) : (a = {}),
                s !== a)
              )
                return (
  ...
  function je(e, t, n, r) {
    ...
    if (
      p &&
      ((s = (i = we(t, e[0].ownerDocument, !1, e, r)).firstChild),
      1 === i.childNodes.length && (i = s),
      s || r)
    ) {
      for (l = (o = x.map(ve(i, "script"), Me)).length; d < p; d++)
        (c = i),
          d !== m &&
  ...
  function Ne(e, t, n) {
    for (var r, i = t ? x.filter(t, e) : e, a = 0; null != (r = i[a]); a++)
      n || 1 !== r.nodeType || x.cleanData(ve(r)),
        r.parentNode &&
  ...
  x.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = ve(o), r = 0, i = (a = ve(e)).length; r < i; r++)
          Oe(a[r], s[r]);
      if (t)
        if (n)
          for (a = a || ve(e), s = s || ve(o), r = 0, i = a.length; r < i; r++)
            Ie(a[r], s[r]);
        else Ie(e, o);
      return (
        (s = ve(o, "script")).length > 0 && ye(s, !l && ve(e, "script")), o
      );
    },
    ...
    x.each(
      ...
      function (e, t) {
        x.fn[e] = function (e) {
          for (var n, r = [], i = x(e), a = i.length - 1, o = 0; o <= a; o++)
  ...
  function Qe(e, t, n, r, i, a) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += x.css(e, n + ne[s], !0, i)),
        r
          ? ("content" === n && (l -= x.css(e, "padding" + ne[s], !0, i)),
            "margin" !== n &&
              (l -= x.css(e, "border" + ne[s] + "Width", !0, i)))
          : ((l += x.css(e, "padding" + ne[s], !0, i)),
            "padding" !== n
              ? (l += x.css(e, "border" + ne[s] + "Width", !0, i))
              : (o += x.css(e, "border" + ne[s] + "Width", !0, i)));
    return (
      !r &&
        a >= 0 &&
        (l +=
  ...
  function Ze(e, t, n) {
    ...
    return (
      ((!f.boxSizingReliable() && i) ||
        ...
        (a = o in e) && (s = e[o])),
      (s = parseFloat(s) || 0) +
        Qe(e, t, n || (i ? "border" : "content"), a, r, s) +
        "px"
    );
  }
  ...
  function ct(e, t, n) {
    ...
    for (
      ...
      if ((r = ct.prefilters[a].call(c, e, u, c.opts)))
        return (
          h(r.stop) &&
        ...
        if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              m && ue([e], !0),
              p.done(function () {
                for (r in (m || ue([e]), U.remove(e, "fxshow"), f))
                  x.style(e, r, f[r]);
              })),
              (l = lt(m ? g[r] : 0, r, p)),
              r in g ||
    ...
    x.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, a = x.makeArray(t), s = i.length;
              s--;

            )
              ((r = i[s]).selected =
                x.inArray(x.valHooks.option.get(r), a) > -1) && (n = !0);
      ...
      ajax: function (t, n) {
        ...
        f.hasContent
          ...
          : ((p = f.url.slice(i.length)),
            ...
            !1 === f.cache &&
              ((i = i.replace(kt, "$1")),
              (p = (St.test(i) ? "&" : "?") + "_=" + xt.guid++ + p)),
            (f.url = i + p)),
        f.ifModified &&
          (x.lastModified[i] &&
            _.setRequestHeader("If-Modified-Since", x.lastModified[i]),
          x.etag[i] && _.setRequestHeader("If-None-Match", x.etag[i])),
        ...
        function C(t, n, s, l) {
          ...
          c ||
            ...
            s &&
              (w = (function (e, t, n) {
                for (
                  var r, i, a, s, o = e.contents, l = e.dataTypes;
                  "*" === l[0];
            ...
            d
              ? (f.ifModified &&
                  ((S = _.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[i] = S),
                  (S = _.getResponseHeader("etag")) && (x.etag[i] = S)),
                204 === t || "HEAD" === f.type
                  ? (T = "nocontent")
                  : 304 === t
                  ? (T = "notmodified")
    ...
    x.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (o || "jsonp" === t.dataTypes[0])
        return (
          ...
          r.always(function () {
            void 0 === a ? x(e).removeProp(i) : (e[i] = a),
...
($jscomp.polyfill = function (e, t, n, r) {
  t &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(e, t, n, r)
      : $jscomp.polyfillUnisolated(e, t, n, r));
}),
  ...
  ($jscomp.polyfillIsolated = function (e, t, n, r) {
    ...
    (i = i[i.length - 1]),
      null !=
        (t = t((n = $jscomp.IS_SYMBOL_NATIVE && "es6" === n ? r[i] : null))) &&
        (e
          ...
          : t !== n &&
            (($jscomp.propertyToPolyfillSymbol[i] = $jscomp.IS_SYMBOL_NATIVE
              ...
              : $jscomp.POLYFILL_PREFIX + i),
            (i = $jscomp.propertyToPolyfillSymbol[i]),
            $jscomp.defineProperty(r, i, {
              configurable: !0,
              writable: !0,
              value: t,
            })));
  ...
  (function (e) {
    ...
    function s(e) {
      ...
      if ((n && He(n), e)) {
        ...
        !e.sEmptyTable &&
          r &&
          "Nenhum resultado encontrado" === t.sEmptyTable &&
          ke(e, e, "sZeroRecords", "sEmptyTable"),
          !e.sLoadingRecords &&
            r &&
            "Loading..." === t.sLoadingRecords &&
            ke(e, e, "sZeroRecords", "sLoadingRecords"),
          e.sInfoThousands && (e.sThousands = e.sInfoThousands),
          (e = e.sDecimal) && n !== e && He(e);
      }
    }
    function o(e) {
      if (
        (ct(e, "ordering", "bSort"),
        ct(e, "orderMulti", "bSortMulti"),
        ct(e, "orderClasses", "bSortClasses"),
        ct(e, "orderCellsTop", "bSortCellsTop"),
        ct(e, "order", "aaSorting"),
        ct(e, "orderFixed", "aaSortingFixed"),
        ct(e, "paging", "bPaginate"),
        ct(e, "pagingType", "sPaginationType"),
        ct(e, "pageLength", "iDisplayLength"),
        ct(e, "searching", "bFilter"),
    ...
    function l(e) {
      ct(e, "orderable", "bSortable"),
        ct(e, "orderData", "aDataSort"),
        ct(e, "orderSequence", "asSorting"),
        ct(e, "orderDataType", "sortDataType");
      var t = e.aDataSort;
    ...
    function d(t, r) {
      ...
      (i = e.extend({}, qe.models.oColumn, i, {
        ...
        t.aoColumns.push(i),
        ((i = t.aoPreSearchCols)[a] = e.extend({}, qe.models.oSearch, i[a])),
        p(t, a, e(r).data());
    }
    function p(t, n, i) {
      n = t.aoColumns[n];
      ...
      (i = function (e) {
        ...
        (n._bAttrSrc =
          e.isPlainObject(u) && (i(u.sort) || i(u.type) || i(u.filter))),
        (n._setter = null),
    ...
    function w(t, n, i, a) {
      ...
      return (
        ...
        (!i && t.oFeatures.bDeferRender) || k(t, s, i, a),
        s
      );
    }
    function x(t, n) {
          ...
          (n !== r && n !== c) ||
            ...
            a && a._bAttrSrc
              ? (ft(a.mData._)(i, s),
                ...
                p(a.mData.filter, e))
              : d
              ? (a._setter || (a._setter = ft(a.mData)), a._setter(i, s))
              : (i[c] = s)),
            c++;
        };
      if (l)
        ...
        for (s = t.aoColumns.length; p < s; p++) {
          ...
          ((l = (o = !i) ? n.createElement(f.sCellType) : a[p])._DT_CellIndex =
            ...
            (!o &&
              ...
              (l.innerHTML = S(t, r, p, "display")),
            f.sClass && (l.className += " " + f.sClass),
            f.bVisible && !i
              ? d.appendChild(l)
              : !f.bVisible && i && l.parentNode.removeChild(l),
            f.fnCreatedCell &&
              f.fnCreatedCell.call(t.oInstance, l, S(t, r, p), c, r, p);
        }
    ...
    function M(t, n) {
      ...
      r &&
        ...
        i.DT_RowClass &&
          ...
          (n.__rowc = n.__rowc ? st(n.__rowc.concat(t)) : t),
    ...
    function P(t) {
      ...
      if (
        (s && $(t.aoHeader, i),
        e(i).children("tr").children("th, td").addClass(o.sHeaderTH),
      ...
      if (n) {
        ...
        for (a = n.length; u < a; u++) {
          for (o[u] = n[u].slice(), o[u].nTr = n[u].nTr, s = c - 1; 0 <= s; s--)
            t.aoColumns[s].bVisible || i || o[u].splice(s, 1);
          l.push([]);
        }
          ...
          for (s = 0, n = o[u].length; s < n; s++) {
            ...
            if (l[u][s] === r) {
              for (
                ...
                o[u + c] !== r && o[u][s].cell == o[u + c][s].cell;
    ...
    function O(t, n) {
      ...
      if (
        (a !== r &&
          -1 !== a &&
          ((t._iDisplayStart = i ? a : a >= t.fnRecordsDisplay() ? 0 : a),
          (t.iInitDisplayStart = -1)),
        (i = Oe(t, "aoPreDrawCallback", "preDraw", [t])),
        -1 !== e.inArray(!1, i))
      )
        ce(t, !1);
      else {
        ...
        if (((t.bDrawing = !0), t.bDeferLoading))
          (t.bDeferLoading = !1), t.iDraw++, ce(t, !1);
        else if (c) {
        ...
        if (0 !== u.length)
          for (n = c ? t.aoData.length : p, l = c ? 0 : d; l < n; l++) {
            ...
            Oe(t, "aoRowCallback", null, [h, f._aData, s, l, c]),
              i.push(h),
              s++;
          }
        else
      ...
      for (s = 0, a = n.length; s < a; s++) {
        ...
        for (r = o.firstChild; r; ) {
          if (
            ...
            for (i = 0; i < l; i++)
              for (u = 0; u < c; u++)
                (t[s + u][d + i] = { cell: r, unique: p }), (t[s + u].nTr = o);
          }
          r = r.nextSibling;
        }
      }
    ...
    function H(t, n, r) {
      if (
        (Oe(t, "aoServerParams", "serverParams", [n]), n && Array.isArray(n))
      ) {
        var i = {},
          a = /(.*?)\[\]$/;
        e.each(n, function (e, t) {
          (e = t.name.match(a))
            ? ((e = e[0]), i[e] || (i[e] = []), i[e].push(t.value))
            : (i[t.name] = t.value);
        }),
          (n = i);
      }
      var s = t.ajax,
        ...
        l = function (e) {
          ...
          (null === e || ("number" == typeof n && 204 == n)) &&
            W(t, (e = {}), []),
            (n = e.error || e.sError) && Le(t, 0, n),
            (t.json = e),
            Oe(t, null, "xhr", [t, e, t.jqXHR]),
            r(e);
        };
      ...
      (u = {
        ...
        error: function (n, r, i) {
          (i = Oe(t, null, "xhr", [t, null, t.jqXHR])),
            -1 === e.inArray(!0, i) &&
              ("parsererror" == r
                ? Le(t, 0, "Invalid JSON response", 1)
                : 4 === n.readyState && Le(t, 0, "Ajax error", 7)),
            ce(t, !1);
        },
      }),
        (t.oAjaxData = n),
        Oe(t, null, "preXhr", [t, n]),
        t.fnServerData
          ? t.fnServerData.call(
              o,
              t.sAjaxSource,
    ...
    function F(t) {
      ...
      for (c = 0; c < r; c++) {
        ...
        (u = "function" == typeof f.mData ? "function" : f.mData),
          ...
          i.bSort && d("bSortable_" + c, f.bSortable);
      }
      return (
        ...
        null === (n = qe.ext.legacy.ajax) ? (t.sAjaxSource ? o : p) : n ? o : p
      );
    }
    function B(e, t) {
      var n = function (e, n) {
    ...
    function W(t, n, i) {
      if (
        ...
        return "data" === t ? n.aaData || n[t] : "" !== t ? pt(t)(n) : n;
      ft(t)(n, i);
    }
    function q(t) {
      var r = t.oClasses,
        ...
        s = t.oPreviousSearch,
        o = t.aanFeatures,
        l = '<input type="Pesquisar" class="' + r.sFilterInput + '"/>',
        c = a.sSearch;
      ...
      var d = e("input", r)
        ...
        .on("keyup.DT search.DT input.DT paste.DT cut.DT", o ? yt(u, o) : u)
    ...
    function V(t) {
      for (
        var n, r, i = qe.ext.search, a = t.aiDisplay, s = 0, o = i.length;
        s < o;
        s++
      ) {
    ...
    function G(e, t, n, r, i, a) {
      if ("" !== t) {
        var s = [],
          o = e.aiDisplay;
        for (r = U(t, r, i, a), i = 0; i < o.length; i++)
          (t = e.aoData[o[i]]._aFilterData[n]), r.test(t) && s.push(o[i]);
        e.aiDisplay = s;
      }
    }
    function Y(e, t, n, r, i, a) {
      ...
      if (0 >= t.length) e.aiDisplay = o.slice();
        ...
        for (
          ...
          i.test(e.aoData[t[n]]._sFilterRow) && a.push(t[n]);
        e.aiDisplay = a;
      }
    }
    function U(t, n, r, i) {
      ...
      for (t = e.aoData.length; a < t; a++) {
        ...
        if (!s._aFilterData) {
          ...
          for (i = 0, n = r.length; i < n; i++) {
            var l = r[i];
            l.bSearchable
              ? (null === (l = S(e, a, i, "filter")) && (l = ""),
                "string" != typeof l && l.toString && (l = l.toString()))
              : (l = ""),
              l.indexOf &&
                -1 !== l.indexOf("&") &&
                ((mt.innerHTML = l), (l = gt ? mt.textContent : mt.innerText)),
    ...
    function ee(t) {
      ...
      if (0 !== n.length) {
        ...
        o !== s && (l += " " + r.sInfoFiltered),
          (l = te(t, (l += r.sInfoPostFix))),
          null !== (r = r.fnInfoCallback) &&
            (l = r.call(t.oInstance, t, i, a, s, o, l)),
          e(n).html(l);
      }
    }
    function te(e, t) {
      ...
      return t
        ...
        .replace(/_PAGES_/g, n.call(e, s ? 1 : Math.ceil(a / i)));
    }
    function ne(e) {
    ...
    function re(e, t) {
      (e._bInitComplete = !0),
        ...
        Oe(e, null, "plugin-init", [e, t]),
        Oe(e, "aoInitComplete", "init", [e, t]);
    }
    function ie(e, t) {
      (t = parseInt(t, 10)),
        (e._iDisplayLength = t),
        je(e),
        Oe(e, null, "length", [e, t]);
    }
    function ae(t) {
      var n = t.oClasses,
        r = t.sTableId,
      ...
      for (var o = 0, l = s.length; o < l; o++)
        a[0][o] = new Option(
          "number" == typeof i[o] ? t.fnFormatNumber(i[o]) : i[o],
          s[o]
        );
            ...
            fn: function (e) {
              if (i) {
                ...
                for (
                  ...
                  Ne(e, "pageButton")(e, s.p[c], c, l, n, o);
              } else r.fnUpdate(e, a);
            },
            sName: "pagination",
          })),
    ...
    function de(n) {
      ...
      if (n.scrollBarVis !== P && n.scrollBarVis !== r)
        ...
        (b = b.find("tr")),
          ...
          Math.round(w.outerWidth()) < Math.round(l)
            ? ((O =
          ...
          !o && C && (g.height = ve(x.offsetHeight + i)),
          (a = w.outerWidth()),
          ...
          (d[(o = "padding" + (_.bScrollbarLeft ? "Left" : "Right"))] = s
            ...
            : "0px"),
          T &&
            ((y[0].style.width = ve(a)),
            (v[0].style.width = ve(a)),
            (v[0].style[o] = s ? i + "px" : "0px")),
    ...
    function pe(e, t, n) {
      for (var r, i, a = 0, s = 0, o = t.length; s < o; ) {
        for (r = t[s].firstChild, i = n ? n[s].firstChild : null; r; )
          1 === r.nodeType && (n ? e(r, i, a) : e(r, a), a++),
            (r = r.nextSibling),
    ...
    function fe(n) {
      ...
      for (
        s = w.bScrollOversize,
          (r = i.style.width) && -1 !== r.indexOf("%") && (m = r),
          r = 0;
        r < d.length;
        r++
      ) {
      ...
      if (s || (!b && !l && !o && u == g(n) && u == p.length))
        for (r = 0; r < u; r++)
          null !== (d = h(n, r)) && (a[d].sWidth = ve(p.eq(r).width()));
      else {
        (u = e(i).clone().css("visibility", "hidden").removeAttr("id"))
          .find("tbody tr")
          .remove();
        ...
        if (n.aoData.length)
          for (r = 0; r < d.length; r++)
            (x = a[(b = d[r])]),
              e(me(n, b)).clone(!1).append(x.sContentPadding).appendTo(S);
        for (
          e("[name]", u).removeAttr("name"),
            ...
            l && c
              ...
              ? (u.css("width", "auto"),
                u.removeAttr("width"),
                u.width() < y.clientWidth && m && u.width(y.clientWidth))
              : o
              ? u.width(y.clientWidth)
              : m && u.width(m),
            r = o = 0;
          r < d.length;
          r++
        )
          (c = (y = e(p[r])).outerWidth() - y.width()),
            (o += y =
              w.bBounding
    ...
    function ge(e, t) {
      for (var n, r = -1, i = -1, a = 0, s = e.aoData.length; a < s; a++)
        (n = (n = (n = S(e, a, t, "display") + "").replace(vt, "")).replace(
          /&nbsp;/g,
          " "
    ...
    function ye(t) {
      ...
      for (
        ...
        for (a = 0, s = (l = i[c].aDataSort).length; a < s; a++) {
          var u = l[a],
            d = i[u].sType || "string";
          o[t]._idx === r && (o[t]._idx = e.inArray(o[t][1], i[u].asSorting)),
            n.push({
              src: c,
              col: u,
              dir: o[t][1],
        ...
        a === o.length
          ...
          : s.sort(function (e, t) {
              ...
              for (a = 0; a < s; a++) {
                ...
                if (
                  0 !==
                  (d = (u = r[u.type + "-" + u.dir] || r["string-" + u.dir])(
                    d,
                    p
                  ))
                )
    ...
    function xe(t, n, i, a) {
      var s = t.aaSorting,
        ...
        l = function (t, n) {
          var i = t._idx;
          return (
            i === r && (i = e.inArray(t[1], o)),
            i + 1 < o.length ? i + 1 : n ? null : 0
          );
        };
      "number" == typeof s[0] && (s = t.aaSorting = [s]),
        i && t.oFeatures.bSortMulti
          ? -1 !== (i = e.inArray(n, nt(s, "0")))
            ? (null === (n = l(s[i], !0)) && 1 === s.length && (n = 0),
              null === n ? s.splice(i, 1) : ((s[i][1] = o[n]), (s[i]._idx = n)))
    ...
    function Te(t) {
      ...
      if (s.bSort && s.bSortClasses) {
        ...
        for (s = 0, n = a.length; s < n; s++)
          (o = a[s].src),
            e(nt(t.aoData, "anCells", o)).addClass(i + (2 > s ? s + 1 : 3));
      }
      t.aLastSort = a;
    }
    function _e(e, t) {
      ...
      for (
        var a,
          s = qe.ext.type.order[r.sType + "-pre"],
          o = 0,
          l = e.aoData.length;
        o < l;
        o++
      )
        (r = e.aoData[o])._aSortData || (r._aSortData = []),
          (!r._aSortData[t] || i) &&
            ((a = i ? n[o] : S(e, o, t, "sort")),
    ...
    function Ce(t) {
      if (!t._bLoadingState) {
        ...
        (t.oSavedState = n),
          Oe(t, "aoStateSaveParams", "stateSaveParams", [t, n]),
    ...
    function De(t, n, i) {
      ...
      if (n && n.time) {
        ...
        if (-1 !== e.inArray(!1, l)) t._bLoadingState = !1;
        else if (0 < (l = t.iStateDuration) && n.time < +new Date() - 1e3 * l)
          t._bLoadingState = !1;
          ...
          if (
            ...
            n.search !== r && e.extend(t.oPreviousSearch, Q(n.search)),
            n.columns)
          ) {
            for (l = 0, a = n.columns.length; l < a; l++) {
              ...
              c.visible !== r &&
                (o
                  ? o.column(l).visible(c.visible, !1)
                  : (s[l].bVisible = c.visible)),
                c.search !== r && e.extend(t.aoPreSearchCols[l], Q(c.search));
            }
            o && o.columns.adjust();
          }
          (t._bLoadingState = !1),
            Oe(t, "aoStateLoaded", "stateLoaded", [t, n]);
        }
    ...
    function Le(e, n, r, i) {
      if (
        ...
        ((n = (n = qe.ext).sErrMode || n.errMode),
        e && Oe(e, null, "error", [e, i, r]),
        "alert" == n)
      )
        alert(r);
      else {
    ...
    function Me(t, n, r) {
      ...
      for (i in n)
        if (n.hasOwnProperty(i)) {
          var a = n[i];
          e.isPlainObject(a)
            ? (e.isPlainObject(t[i]) || (t[i] = {}), e.extend(!0, t[i], a))
            : r && "data" !== i && "aaData" !== i && Array.isArray(a)
            ? (t[i] = a.slice())
            : (t[i] = a);
        }
      return t;
    ...
    function ze(e, t) {
      ...
      return (
        t <= n
          ...
          : (e >= t - 1 - r
              ? (e = it(t - (n - 2), t))
              : ((e = it(e - r + 2, e + r - 1)).push("ellipsis"),
                e.push(t - 1)),
    ...
    function He(t) {
      e.each(
        ...
        function (e, n) {
          (Fe.type.order[e + t + "-pre"] = n),
            e.match(/^html\-/) && (Fe.type.search[e + t] = Fe.type.search.html);
        }
      );
    }
    function Re(e) {
      return function () {
        var t = [Ae(this[qe.ext.iApiIndex])].concat(
    ...
    var Fe,
      ...
      qe = function (t, n) {
        ...
        (n = t),
          ...
          (this.fnDeleteRow = function (e, t, n) {
            var i = this.api(!0),
              ...
              s = a.aoData[e[0][0]];
            return (
              e.remove(), t && t.call(this, a, s), (n === r || n) && i.draw(), s
            );
          }),
        ...
        var i = this,
          ...
          f = this.length;
        for (var h in (u && (n = {}),
        (this.oApi = this.internal = Fe.internal),
        qe.ext.internal))
          h && (this[h] = Re(h));
        return (
          this.each(function () {
            ...
            if ("table" != this.nodeName.toLowerCase())
              ...
              o(y),
                l(y.column),
                a(y, y, !0),
                a(y.column, y.column, !0),
                a(y, e.extend(m, S.data()), !0);
              var T = qe.settings;
              ...
              (null !== h && "" !== h) ||
                (this.id = h = "DataTables_Table_" + qe.ext._unique++);
              ...
              (E.nTable = this),
                ...
                (E.oInit = m),
                T.push(E),
                (E.oInstance = 1 === i.length ? i : S.dataTable()),
                o(m),
                s(m.oLanguage),
                m.aLengthMenu &&
                  !m.iDisplayLength &&
                ...
                ke(E.oLanguage, m, "fnInfoCallback"),
                Ie(E, "aoDrawCallback", m.fnDrawCallback, "user"),
                Ie(E, "aoServerParams", m.fnServerParams, "user"),
                Ie(E, "aoStateSaveParams", m.fnStateSaveParams, "user"),
                Ie(E, "aoStateLoadParams", m.fnStateLoadParams, "user"),
                Ie(E, "aoStateLoaded", m.fnStateLoaded, "user"),
                Ie(E, "aoRowCallback", m.fnRowCallback, "user"),
                Ie(E, "aoRowCreatedCallback", m.fnCreatedRow, "user"),
                Ie(E, "aoHeaderCallback", m.fnHeaderCallback, "user"),
                Ie(E, "aoFooterCallback", m.fnFooterCallback, "user"),
                Ie(E, "aoInitComplete", m.fnInitComplete, "user"),
                Ie(E, "aoPreDrawCallback", m.fnPreDrawCallback, "user"),
                (E.rowIdFn = pt(m.rowId)),
                c(E);
              var D = E.oClasses;
              e.extend(D, qe.ext.classes, m.oClasses),
                S.addClass(D.sTable),
              ...
              if (
                (b(E, m.aoColumnDefs, T, function (e, t) {
                  p(E, e, t);
                }),
                L.length)
              ) {
              ...
              (h = function () {
                ...
                0 === i.length && (i = e("<thead/>").appendTo(S)),
                  (E.nTHead = i[0]);
                var a = S.children("tbody");
                if (
                  (0 === a.length && (a = e("<tbody/>").insertAfter(i)),
                  (E.nTBody = a[0]),
                  0 === (i = S.children("tfoot")).length &&
                    0 < n.length &&
                    ("" !== E.oScroll.sX || "" !== E.oScroll.sY) &&
                    (i = e("<tfoot/>").appendTo(S)),
                  0 === i.length || 0 === i.children().length
                    ? S.addClass(D.sNoFooter)
                    : 0 < i.length &&
                      ((E.nTFoot = i[0]), $(E.aoFooter, E.nTFoot)),
                  m.aaData)
                )
                  for (g = 0; g < m.aaData.length; g++) w(E, m.aaData[g]);
                else
                  (E.bDeferLoading || "dom" == $e(E)) &&
                    x(E, e(E.nTBody).children("tr"));
                (E.aiDisplay = E.aiDisplayMaster.slice()),
                  (E.bInitialised = !0),
                  !1 === v && ne(E);
              }),
                Ie(E, "aoDrawCallback", Ce, "state_save"),
      ...
      Ze = function (e, t) {
        return (
          Xe[t] || (Xe[t] = new RegExp(ht(t), "g")),
          "string" == typeof e && "." !== t
            ? e.replace(/\./g, "").replace(Xe[t], ".")
            : e
        );
      },
      et = function (e, t, n) {
      ...
      tt = function (e, t, n) {
        return (
          !!Je(e) ||
          ((Je(e) || "string" == typeof e) && !!et(e.replace(Ge, ""), t, n)) ||
          null
        );
      },
      nt = function (e, t, n) {
        var i = [],
          a = 0,
          s = e.length;
        if (n !== r) for (; a < s; a++) e[a] && e[a][t] && i.push(e[a][t][n]);
        else for (; a < s; a++) e[a] && i.push(e[a][t]);
        return i;
      },
      rt = function (e, t, n, i) {
        var a = [],
          s = 0,
          o = t.length;
        if (i !== r) for (; s < o; s++) e[t[s]][n] && a.push(e[t[s]][n][i]);
      ...
      ot = function (e, t) {
        if (Array.isArray(t)) for (var n = 0; n < t.length; n++) ot(e, t[n]);
        else e.push(t);
        return e;
      },
      lt = function (e, t) {
    ...
    Array.isArray ||
      ...
      Array.prototype.includes || (Array.prototype.includes = lt),
      String.prototype.trim ||
        (String.prototype.trim = function () {
          return this.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
        }),
      String.prototype.includes || (String.prototype.includes = lt),
      (qe.util = {
        ...
        set: function (t) {
          ...
          var n = function (e, t, i) {
            for (
              var a, s, o = (i = _(i))[i.length - 1], l = 0, c = i.length - 1;
              l < c;
              l++
            ) {
              if ("__proto__" === i[l] || "constructor" === i[l])
                throw Error("Cannot set prototype values");
              if (((a = i[l].match(ut)), (s = i[l].match(dt)), a)) {
                if (
                  ((i[l] = i[l].replace(ut, "")),
                  (e[i[l]] = []),
                  (o = i.slice()).splice(0, l + 1),
                  (a = o.join(".")),
                  Array.isArray(t))
                )
                  for (s = 0, c = t.length; s < c; s++)
                    n((o = {}), t[s], a), e[i[l]].push(o);
                else e[i[l]] = t;
                return;
              }
              s && ((i[l] = i[l].replace(dt, "")), (e = e[i[l]](t))),
                (null !== e[i[l]] && e[i[l]] !== r) || (e[i[l]] = {}),
                (e = e[i[l]]);
            }
    ...
    var ct = function (e, t, n) {
      ...
      xt = function (t, n) {
        ...
        if (Array.isArray(t)) for (var a = 0, s = t.length; a < s; a++) i(t[a]);
        else i(t);
        (this.context = st(r)),
          n && e.merge(this, n),
    ...
    (qe.Api = xt),
        ...
        iterator: function (e, t, n, i) {
          ...
          for (a = c.length; d < a; d++) {
            ...
            if ("table" === t) {
              ...
              (f = n.call(p, c[d], this[d], d)) !== r && l.push(f);
            else if (
              "column" === t ||
              "column-rows" === t ||
              "row" === t ||
                ...
                (f = h[m]),
                  (f =
                    "cell" === t
                      ...
                      : n.call(p, c[d], f, d, m, o)) !== r && l.push(f);
            }
          }
          return l.length || i
            ? (((t = (e = new xt(c, e ? l.concat.apply([], l) : l))
        ...
        if (n.length && t && (t instanceof xt || t.__dt_wrapper)) {
          ...
          for (r = n.length; a < r; a++) {
            ...
            (t[s.name] =
              ...
              xt.extend(e, t[s.name], s.propExt);
          }
        }
      }),
      (xt.register = Be =
      ...
      (xt.registerPlural = We =
        function (e, t, n) {
          xt.register(e, n),
            xt.register(t, function () {
    ...
    var _t = function (e, t, n, i, a) {
        var s,
          ...
          u = typeof t;
        for (
          (t && "string" !== u && "function" !== u && t.length !== r) ||
            (t = [t]),
            u = 0,
            o = t.length;
          u < o;
    ...
    Be("rows()", function (t, n) {
          ...
          return (function (t, n, i) {
            ...
            return _t(
              ...
              function (n) {
                ...
                if ((a || (a = Dt(t, i)), null !== s && -1 !== e.inArray(s, a)))
                  return [s];
                ...
                return "string" == typeof n &&
                  "#" === n.charAt(0) &&
                  (s = t.aIds[n.replace(/^#/, "")]) !== r
                  ? [s.idx]
                  : ((s = at(rt(t.aoData, a, "nTr"))),
                    e(s)
                      .filter(n)
                      .map(function () {
        ...
        return (
          this.iterator("row", function (t, n, i) {
            ...
            D(t.aiDisplayMaster, n),
              ...
              je(t),
              (n = t.rowIdFn(l._aData)) !== r && delete t.aIds[n];
          }),
      ...
      Be("row().data()", function (e) {
        var t = this.context;
        if (e === r)
          return t.length && this.length ? t[0].aoData[this[0]]._aData : r;
        var n = t[0].aoData[this[0]];
        return (
          (n._aData = e),
          Array.isArray(e) && n.nTr && n.nTr.id && ft(t[0].rowId)(e, n.nTr.id),
          A(t[0], this[0], "data"),
          this
        );
      }),
    ...
    var At = function (t, n) {
        ...
        if (r.length && t.length) {
          ...
          i._details &&
            ((i._detailsShow = n)
              ...
              : (i._details.detach(), e(i.nTr).removeClass("dt-hasChild")),
            Oe(r[0], null, "childRow", [n, t.row(t[0])]),
            kt(r[0]),
            Ce(r[0]));
        }
      },
      kt = function (e) {
        ...
        t.off(
          ...
          0 < nt(n, "_details").length &&
            (t.on("draw.dt.DT_details", function (r, i) {
              e === i &&
                t
                  .rows({ page: "current" })
                  .eq(0)
            ...
            t.on("column-visibility.dt.DT_details", function (t, r, i, a) {
              if (e === r)
                for (r = g(r), i = 0, a = n.length; i < a; i++)
                  (t = n[i])._details &&
                    t._details.children("td[colspan]").attr("colspan", r);
            }),
                  ...
                  s = function (n, r) {
                    if (Array.isArray(n) || n instanceof e)
                      ...
                      n.nodeName && "tr" === n.nodeName.toLowerCase()
                        ? a.push(n)
                        : ((i = e("<tr><td></td></tr>").addClass(r)),
                          (e("td", i).addClass(r).html(n)[0].colSpan = g(t)),
                          a.push(i[0]));
                  };
                s(r, i),
    ...
    Be("cells()", function (t, n, i) {
            ...
            return _t(
              ...
              function (n) {
                ...
                return e.isPlainObject(n)
                  ? n.column !== r && n.row !== r && -1 !== e.inArray(n.row, f)
                    ? [n]
                    : []
                  : (i = m
                      .filter(n)
      ...
      var a,
        ...
        o,
        l,
        c = i ? { page: i.page, order: i.order, search: i.search } : {},
        u = this.columns(n, c),
        d = this.rows(t, c);
      return (
        (c = this.iterator(
        ...
        (c = i && i.selected ? this.cells(c, i) : c),
        e.extend(c.selector, { cols: n, rows: t, opts: i }),
        c
      );
    }),
      ...
      (qe.versionCheck = qe.fnVersionCheck =
        function (e) {
          for (
            ...
            if ((t = parseInt(r[i], 10) || 0) !== (n = parseInt(e[i], 10) || 0))
              return t > n;
          return !0;
        }),
      (qe.isDataTable = qe.fnIsDataTable =
        function (t) {
          ...
          return (
            t instanceof qe.Api ||
            (e.each(qe.settings, function (t, i) {
      ...
      Be("destroy()", function (n) {
        return (
          ...
          this.iterator("table", function (r) {
            ...
            (r.bDestroying = !0),
              Oe(r, "aoDestroyCallback", "destroy", [r]),
              n || new xt(r).columns().visible(!0),
              ...
              -1 !== (i = e.inArray(r, qe.settings)) &&
                qe.settings.splice(i, 1);
          })
        );
      }),
      ...
      Be("i18n()", function (t, n, i) {
        ...
        return (
          (t = pt(t)(a.oLanguage)) === r && (t = n),
          i !== r && e.isPlainObject(t) && (t = t[i] !== r ? t[i] : t._),
          t.replace("%d", i)
        );
      }),
      (qe.version = "1.11.4"),
      ...
      (qe.defaults = {
        ...
        oLanguage: {
          ...
          sInfoEmpty: "Mostrando 0 à 0 de 0 resultados",
    ...
    e.extend(It, {
                  ...
                  if (Array.isArray(y)) {
                    ...
                    switch (((c = null), (u = y), (b = t.iTabIndex), y)) {
                      ...
                      case "last":
                        ...
                        break;
                      default:
                        (c = t.fnFormatNumber(y + 1)),
                          (u = o === y ? d.sPageButtonActive : "");
                    }
                    null !== c &&
                      (Pe(
                        (b = e("<a>", {
      ...
      e.extend(qe.ext.type.detect, [
        function (e, t) {
          return (t = t.oLanguage.sDecimal), et(e, t) ? "num" + t : null;
        },
        function (e, t) {
          return (!e || e instanceof Date || Ye.test(e)) &&
            ((null !== (t = Date.parse(e)) && !isNaN(t)) || Je(e))
            ? "date"
            : null;
        },
        function (e, t) {
          return (
            (t = t.oLanguage.sDecimal), et(e, t, !0) ? "num-fmt" + t : null
          );
        },
        function (e, t) {
        ...
        function (e, t) {
          return (
            (t = t.oLanguage.sDecimal), tt(e, t, !0) ? "html-num-fmt" + t : null
          );
        },
        function (e, t) {
          return Je(e) || ("string" == typeof e && -1 !== e.indexOf("<"))
            ? "html"
            : null;
        },
      ]),
  ...
  (function (e, t) {
          ...
          (("body" !== u(n) || h(g)) &&
            (y =
              (a = n) !== t(a) && r(a)
                ...
                : c(a)),
          r(n)
            ? (((b = l(n, !0)).x += n.clientLeft), (b.y += n.clientTop))
            : g && (b.x = p(g))),
        {
    ...
    function v(e) {
      return "html" === u(e)
        ? e
        : e.assignedSlot || e.parentNode || (i(e) ? e.host : null) || d(e);
    }
    function y(e) {
    ...
    function S(e) {
      for (var n = t(e), i = x(e); i && w(i) && "static" === f(i).position; )
        i = x(i);
      return i &&
        ("html" === u(i) || ("body" === u(i) && "static" === f(i).position))
        ? n
        : i ||
            (function (e) {
              var t =
      ...
      return r === M
        ...
        : H(
            (function (e) {
              ...
              return (
                "rtl" === f(i || n).direction &&
                  (l += a(n.clientWidth, i ? i.clientWidth : 0) - s),
      ...
      var o =
          "clippingParents" === t
            ? (function (e) {
                var t = b(v(e)),
                  i =
                    ["absolute", "fixed"].indexOf(f(e).position) >= 0 && r(e)
                      ? S(e)
                      : e;
                return n(i)
                  ? t.filter(function (e) {
    ...
    function G(e, t) {
      ...
      var r = t,
        ...
        D = q({ reference: E, element: w, strategy: "absolute", placement: a }),
                ...
                if (U(t, n)) {
                  ...
                  for (var r = 0; r < l.orderedModifiers.length; r++)
                    if (!0 !== l.reset) {
                      ...
                      "function" == typeof a &&
                        (l =
                          a({ state: l, options: o, name: c, instance: d }) ||
                          l);
                    } else (l.reset = !1), (r = -1);
                }
              }
    ...
    function te(e) {
      var n,
        ...
        y = l.y,
        b = void 0 === y ? 0 : y,
        w = "function" == typeof h ? h({ x: v, y: b }) : { x: v, y: b };
      (v = w.x), (b = w.y);
      ...
      if (p) {
        ...
        P === t(r) &&
          ...
          (a === T || ((a === E || a === C) && s === k)) &&
            ((L = _),
            (b -=
              (m && M.visualViewport ? M.visualViewport.height : P[I]) -
              i.height),
            (b *= u ? 1 : -1)),
          (a !== E && ((a !== T && a !== _) || s !== k)) ||
            ((A = C),
            (v -=
              (m && M.visualViewport ? M.visualViewport.width : P[O]) -
              i.width),
            (v *= u ? 1 : -1));
      }
      var j,
        N = Object.assign({ position: c }, p && ee),
        $ =
          !0 === h
            ? (function (e) {
                var t = e.x,
              ...
              return (
                (e[n] = (function (e, t, n) {
                  ...
                  return (
                    (s = s || 0),
                    (o = (o || 0) * i),
                    [E, C].indexOf(r) >= 0 ? { x: o, y: s } : { x: s, y: o }
                  );
                })(n, t.rects, a)),
                e
              );
          ...
          if (M) {
            if (o) {
              var H,
                ...
                re = de(0, P[q], Z[q]),
                ie = D
                  ? P[q] / 2 - U - re - te - j.mainAxis
                  : K - re - te - j.mainAxis,
                ae = D
                  ? -P[q] / 2 + U + re + ne + j.mainAxis
                  : J + re + ne + j.mainAxis,
    ...
    var ge = {
      ...
      ve = K({ defaultModifiers: [Q, Z, ne, re] }),
  ...
  (function (e, t) {
    ...
    class se extends R {
      ...
      to(e) {
        ...
        if (this._isSliding)
          return void $.one(this._element, re, () => this.to(e));
      ...
      _addEventListeners() {
        this._config.keyboard &&
          $.on(this._element, "keydown.bs.carousel", (e) => this._keydown(e)),
          "hover" === this._config.pause &&
            ($.on(this._element, "mouseenter.bs.carousel", (e) =>
              this.pause(e)
            ),
            $.on(this._element, "mouseleave.bs.carousel", (e) =>
              this.cycle(e)
            )),
          this._config.touch &&
            this._touchSupported &&
        ...
        Y.find(".carousel-item img", this._element).forEach((e) => {
          ...
          this._pointerEvent
            ? ($.on(this._element, "pointerdown.bs.carousel", (e) => t(e)),
              $.on(this._element, "pointerup.bs.carousel", (e) => r(e)),
              this._element.classList.add("pointer-event"))
            : ($.on(this._element, "touchstart.bs.carousel", (e) => t(e)),
              $.on(this._element, "touchmove.bs.carousel", (e) => n(e)),
              $.on(this._element, "touchend.bs.carousel", (e) => r(e)));
      }
      _keydown(e) {
    ...
    $.on(
      ...
      y(se);
    const oe = "collapse",
      le = { toggle: !0, parent: null },
      ce = { toggle: "boolean", parent: "(null|element)" },
      ue = "show",
      de = "collapse",
      pe = "collapsing",
      fe = "collapsed",
    ...
    class ge extends R {
      ...
      show() {
        ...
        if (t.length) {
          ...
          if (((e = r ? ge.getInstance(r) : null), e && e._isTransitioning))
            return;
        }
        if ($.trigger(this._element, "show.bs.collapse").defaultPrevented)
          return;
        t.forEach((t) => {
          n !== t && ge.getOrCreateInstance(t, { toggle: !1 }).hide(),
      ...
      _getConfig(e) {
        return (
          ((e = { ...le, ...G.getDataAttributes(this._element), ...e }).toggle =
            Boolean(e.toggle)),
          (e.parent = l(e.parent)),
          c(oe, e, ce),
          e
      ...
      _addAriaAndCollapsedClass(e, t) {
        e.length &&
          e.forEach((e) => {
            t ? e.classList.remove(fe) : e.classList.add(fe),
    ...
    class Ne extends R {
        ...
        this._inNavbar
          ...
          "ontouchstart" in document.documentElement &&
            ...
            []
              ...
              .forEach((e) => $.on(e, "mouseover", f)),
          this._element.focus(),
          this._element.setAttribute("aria-expanded", !0),
          this._menu.classList.add(Ce),
      ...
      _completeHide(e) {
        $.trigger(this._element, "hide.bs.dropdown", e).defaultPrevented ||
          ("ontouchstart" in document.documentElement &&
            []
              .concat(...document.body.children)
              .forEach((e) => $.off(e, "mouseover", f)),
          this._popper && this._popper.destroy(),
          this._menu.classList.remove(Ce),
      ...
      _getConfig(e) {
        if (
          ...
          c(ve, e, this.constructor.DefaultType),
      ...
      _createPopper(e) {
        ...
        (this._popper = t.createPopper(n, this._menu, r)),
      ...
      static dataApiKeydownHandler(e) {
        if (
          /input|textarea/i.test(e.target.tagName)
            ? e.key === be ||
              (e.key !== ye &&
                ((e.key !== xe && e.key !== we) || e.target.closest(De)))
            : !Se.test(e.key)
        )
          return;
        ...
        if (e.key !== ye)
          return e.key === we || e.key === xe
            ? (t || r.show(), void r._selectMenuItem(e))
            : void ((t && e.key !== be) || Ne.clearMenus());
        r.hide();
      }
    }
    $.on(document, _e, Ee, Ne.dataApiKeydownHandler),
      $.on(document, _e, De, Ne.dataApiKeydownHandler),
      $.on(document, Te, Ne.clearMenus),
      $.on(document, "keyup.bs.dropdown.data-api", Ne.clearMenus),
      $.on(document, Te, Ee, function (e) {
    ...
    class He {
      ...
      hide() {
        ...
        this._disableOverFlow(),
          ...
          this._setElementAttributes($e, "paddingRight", (t) => t + e),
          this._setElementAttributes(ze, "marginRight", (t) => t - e);
      }
      _disableOverFlow() {
      ...
      reset() {
        this._resetElementAttributes(this._element, "overflow"),
          ...
          this._resetElementAttributes($e, "paddingRight"),
          this._resetElementAttributes(ze, "marginRight");
      }
    ...
    class qe {
      ...
      show(e) {
        this._config.isVisible
          ? (this._append(),
            ...
            this._getElement().classList.add(Be),
      ...
      hide(e) {
        this._config.isVisible
          ? (this._getElement().classList.remove(Be),
            this._emulateAnimation(() => {
              this.dispose(), b(e);
            }))
          : b(e);
      ...
      _getConfig(e) {
        return (
          ((e = { ...Re, ...("object" == typeof e ? e : {}) }).rootElement = l(
            e.rootElement
          )),
          c("backdrop", e, Fe),
          e
    ...
    const Xe = { trapElement: null, autofocus: !0 },
      Ve = { trapElement: "element", autofocus: "boolean" },
      Ge = ".bs.focustrap",
      Ye = "backward";
    class Ue {
      constructor(e) {
      ...
      activate() {
        ...
        this._isActive ||
          (t && e.focus(),
          $.off(document, Ge),
          $.on(document, "focusin.bs.focustrap", (e) => this._handleFocusin(e)),
          $.on(document, "keydown.tab.bs.focustrap", (e) =>
    ...
    const Ke = "modal",
      Je = "Escape",
      Qe = { backdrop: !0, keyboard: !0, focus: !0 },
      Ze = {
    ...
    class ct extends R {
      ...
      show(e) {
        this._isShown ||
          ...
          $.trigger(this._element, tt, { relatedTarget: e }).defaultPrevented ||
          ((this._isShown = !0),
      ...
      hide() {
        ...
        e && (this._isTransitioning = !0),
          ...
          $.off(this._element, rt),
          $.off(this._dialog, at),
          this._queueCallback(() => this._hideModal(), this._element, e);
      }
      dispose() {
        [window, this._dialog].forEach((e) => $.off(e, ".bs.modal")),
      ...
      _setEscapeEvent() {
        this._isShown
          ? $.on(this._element, it, (e) => {
              this._config.keyboard && e.key === Je
      ...
      _setResizeEvent() {
        this._isShown
          ? $.on(window, nt, () => this._adjustDialog())
          : $.off(window, nt);
      }
      _hideModal() {
        (this._element.style.display = "none"),
          ...
          (this._isTransitioning = !1),
          this._backdrop.hide(() => {
            document.body.classList.remove(st),
              this._resetAdjustments(),
              this._scrollBar.reset(),
              $.trigger(this._element, et);
          });
      }
      _showBackdrop(e) {
    ...
    $.on(
      ...
      y(ct);
    const ut = "offcanvas",
      dt = { backdrop: !0, keyboard: !0, scroll: !1 },
    ...
    class gt extends R {
      ...
      show(e) {
        this._isShown ||
          $.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e })
            .defaultPrevented ||
          ((this._isShown = !0),
    ...
    $.on(
      ...
      $.on(window, "load.bs.offcanvas.data-api", () =>
        Y.find(ht).forEach((e) => gt.getOrCreateInstance(e).show())
      ),
      F(gt),
      y(gt);
    const vt = new Set([
      ...
      wt = (e, t) => {
        ...
        if (t.includes(n))
          return (
            !vt.has(n) || Boolean(yt.test(e.nodeValue) || bt.test(e.nodeValue))
          );
    ...
    class $t extends R {
      ...
      toggle(e) {
        if (this._isEnabled)
          if (e) {
            ...
            if (this.getTipElement().classList.contains(Lt))
      ...
      dispose() {
        clearTimeout(this._timeout),
          $.off(this._element.closest(It), Ot, this._hideModalHandler),
      ...
      show() {
        ...
        "tooltip" === this.constructor.NAME &&
          this.tip &&
          this.getTitle() !== this.tip.querySelector(Pt).innerHTML &&
        ...
        i.setAttribute("id", a),
          ...
          this._config.animation && i.classList.add(At);
        const s =
      ...
      _setListeners() {
        this._config.trigger.split(" ").forEach((e) => {
          if ("click" === e)
            ...
            $.on(this._element, t, this._config.selector, (e) =>
              this._enter(e)
            ),
          ...
          $.on(this._element.closest(It), Ot, this._hideModalHandler),
          this._config.selector
            ? (this._config = {
                ...this._config,
                trigger: "manual",
      ...
      _enter(e, t) {
        (t = this._initializeOnDelegatedTarget(e, t)),
          e && (t._activeTrigger["focusin" === e.type ? Nt : jt] = !0),
          t.getTipElement().classList.contains(Lt) || t._hoverState === kt
            ? (t._hoverState = kt)
      ...
      _leave(e, t) {
        (t = this._initializeOnDelegatedTarget(e, t)),
          e &&
            (t._activeTrigger["focusout" === e.type ? Nt : jt] =
      ...
      _getConfig(e) {
        ...
        return (
          ...
          c(St, e, this.constructor.DefaultType),
          e.sanitize &&
    ...
    const zt = {
      ...
      Ht = { ...$t.DefaultType, content: "(string|element|function)" },
      Rt = {
    ...
    class Yt extends R {
      ...
      refresh() {
        const e =
            this._scrollElement === this._scrollElement.window ? "offset" : Gt,
          t = "auto" === this._config.method ? e : this._config.method,
          n = t === Gt ? this._getScrollTop() : 0;
        (this._offsets = []),
          (this._targets = []),
          (this._scrollHeight = this._getScrollHeight()),
          Y.find(Vt, this._config.target)
            .map((e) => {
              const r = i(e),
      ...
      _clear() {
        Y.find(Vt, this._config.target)
          .filter((e) => e.classList.contains(Xt))
          .forEach((e) => e.classList.remove(Xt));
      }
      static jQueryInterface(e) {
        return this.each(function () {
    ...
    class en extends R {
      ...
      show() {
        ...
        const r = e
          ? $.trigger(e, "hide.bs.tab", { relatedTarget: this._element })
          : null;
        if (
        ...
        const i = () => {
          $.trigger(e, "hidden.bs.tab", { relatedTarget: this._element }),
            $.trigger(this._element, "shown.bs.tab", { relatedTarget: e });
        };
      ...
      _transitionComplete(e, t, n) {
        ...
        e.classList.add(Ut),
          ...
          h(e),
          e.classList.contains(Kt) && e.classList.add(Jt);
        let r = e.parentNode;
        if (
          ...
          t &&
            Y.find(".dropdown-toggle", t).forEach((e) => e.classList.add(Ut)),
    ...
    $.on(
      ...
      function (e) {
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
          d(this) || en.getOrCreateInstance(this).show();
      }
    ),
      y(en);
    const tn = "toast",
    ...
    class ln extends R {
      ...
      _getConfig(e) {
        return (
          ...
          c(tn, e, this.constructor.DefaultType),
          e
        );
      }
      _maybeScheduleHide() {
      ...
      _setListeners() {
        $.on(this._element, "mouseover.bs.toast", (e) =>
          this._onInteraction(e, !0)
        ),
          $.on(this._element, "mouseout.bs.toast", (e) =>
            this._onInteraction(e, !1)
          ),
          $.on(this._element, "focusin.bs.toast", (e) =>
            this._onInteraction(e, !0)
          ),
          $.on(this._element, "focusout.bs.toast", (e) =>
            this._onInteraction(e, !1)
          );
      }
      _clearTimeout() {
...
($jscomp.polyfill = function (e, t, n, r) {
  ...
  function () {
      ...
      return (
        ...
        (null == e || null == t || (!z(e) && !z(t))
          ...
          : (function (e, t, n, r, i, a) {
              ...
              return 1 & n ||
                ((s = u && te.call(e, "__wrapped__")),
                (l = o && te.call(t, "__wrapped__")),
                !s && !l)
                ? !!c &&
                    ((n = (function (e, t, n, r, i, a) {
                      var s = 1 & n,
      ...
      return function i() {
        for (
          var a = -1,
            ...
            l = n.length,
            c = Array(l + s),
            u = this && this !== K && this instanceof i ? r : e;
          ++o < l;
    ...
    function D(e, t, n) {
      return (
        (t = ce(t === X ? e.length - 1 : t, 0)),
        function () {
          for (
            var r = arguments, i = -1, a = ce(r.length - t, 0), s = Array(a);
            ++i < a;
    ...
    function k(e, t, n) {
      ...
      n =
        ((n = "number" == typeof n ? (0 > n ? ce(r + n, 0) : n) : 0) || 0) - 1;
      for (var i = t == t; ++n < r; ) {
        var a = e[n];
    ...
    function I(e, t) {
      ...
      return (
        ...
        function () {
          return (
            0 < --e && (n = t.apply(this, arguments)), 1 >= e && (t = X), n
          );
        }
      );
    }
    ...
    function R(e) {
      return (
        "string" == typeof e ||
        (!ye(e) && z(e) && "[object String]" == re.call(e))
      );
    }
    function F(e) {
            ...
            o &&
              (e.prototype[r] = function () {
                ...
                if (s || n) {
                  ...
                  return (
                    (r.__actions__ = w(this.__actions__)).push({
                      func: i,
                      args: arguments,
                      thisArg: e,
                    }),
      ...
      ue = (function () {
        ...
        return function (t) {
          return $(t)
            ? ae
              ? ae(t)
              : ((e.prototype = t), (t = new e()), (e.prototype = X), t)
            : {};
        };
      })();
          ...
          if ($(a)) {
            if ("number" == (l = typeof s)) {
              if ((l = j(a)))
                var o = typeof s,
                  l =
                    !!(l = null == (l = a.length) ? 9007199254740991 : l) &&
                    ("number" == o || ("symbol" != o && Y.test(s))) &&
                    -1 < s &&
                    0 == s % 1 &&
                    s < l;
    ...
    (i.assignIn = Se),
      ...
      (i.concat = function () {
        ...
        if (!e) return [];
        for (var n = Array(e - 1), r = arguments[0]; e--; )
          n[e - 1] = arguments[e];
      ...
      (i.isBoolean = function (e) {
        return (
          !0 === e || !1 === e || (z(e) && "[object Boolean]" == re.call(e))
        );
      }),
      (i.isDate = function (e) {
      ...
      (i.isEmpty = function (t) {
        return j(t) && (ye(t) || R(t) || N(t.splice) || e(t))
          ? !t.length
          : !le(t).length;
      }),
      ...
      (i.noop = function () {}),
      (i.reduce = P),
      (i.result = function (e, t, n) {
        return (
          (t = null == e ? X : e[t]) === X && (t = n), N(t) ? t.call(e) : t
        );
      }),
      (i.size = function (e) {
  ...
  (function (e, t) {
    ...
    var v,
      ...
      w = {
          ...
          for (var o = r.split(" "), l = 0; l < o.length; l += 1)
            for (var c = o[l], u = 0; u < this.length; u += 1) {
              ...
              if (
                (!i && d.dom7Listeners
                  ? (p = d.dom7Listeners[c])
                  : i && d.dom7LiveListeners && (p = d.dom7LiveListeners[c]),
                p && p.length)
              )
        ...
        trigger: function () {
          for (
            var e = o(), t = arguments.length, n = new Array(t), r = 0;
            r < t;
            r++
          )
            n[r] = arguments[r];
            ...
            void 0 !== l &&
              ...
              (_(e[o]) && _(r[o])
                ? r[o].__swiper__
                  ...
                  : E(e[o], r[o])
                : !_(e[o]) && _(r[o])
                ? ((e[o] = {}), r[o].__swiper__ ? (e[o] = r[o]) : E(e[o], r[o]))
                : (e[o] = r[o]));
          }
      }
      return e;
        ...
        if (
          ...
          if (r.freeMode) {
            ...
            if (r.freeModeMomentum) {
              ...
              if (
                ...
                if (
                  ...
                  v =
                    A < L ? r.speed : A < 2 * L ? 1.5 * r.speed : 2.5 * r.speed;
                }
            ...
            if (p > r.longSwipesMs) {
              ...
              "next" === t.swipeDirection &&
                (O >= r.longSwipesRatio ? t.slideTo(k + j) : t.slideTo(k)),
                "prev" === t.swipeDirection &&
                  (O > 1 - r.longSwipesRatio ? t.slideTo(k + j) : t.slideTo(k));
            } else {
    ...
    var q = {
      ...
      X = {
        ...
        update: {
            ...
            if (void 0 !== a) {
              ...
              for (
                var C,
                  ...
                  L = r.slidesPerColumn,
                  k = T / L,
                  M = Math.floor(d / r.slidesPerColumn),
                  P = 0;
                P < d;
                P += 1
              ) {
                    ...
                    var $ = Math.floor(
                      ...
                      H =
                        0 === $
                          ? r.slidesPerGroup
                          : Math.min(
                              Math.ceil((d - $ * L * r.slidesPerGroup) / L),
                              r.slidesPerGroup
                            );
                    (O =
                      (j =
          ...
          updateSlidesClasses: function () {
            ...
            r.loop &&
              0 === c.length &&
              (c = n.eq(-1)).addClass(r.slidePrevClass),
              r.loop &&
        ...
        loop: {
          loopCreate: function () {
            ...
            for (var d = 0; d < u.length; d += 1)
              r.append(g(u[d].cloneNode(!0)).addClass(n.slideDuplicateClass));
            for (var p = c.length - 1; p >= 0; p -= 1)
              r.prepend(g(c[p].cloneNode(!0)).addClass(n.slideDuplicateClass));
          },
          loopFix: function () {
            var e = this;
            ...
            if (
              ...
              for (var l = 0; l < s.length; l += 1) {
                var c = s[l],
                  ...
                  d = c.value;
                "window" === t
                  ? i.matchMedia("(min-width: " + d + "px)").matches && (r = u)
                  : d <= n.clientWidth && (r = u);
              }
              return r || "max";
            }
      ...
      G = (function () {
        function t() {
          for (
            var e, n, r = arguments.length, i = new Array(r), a = 0;
            a < r;
            a++
          )
            i[a] = arguments[a];
          ...
          (i.slidesPerViewDynamic = function () {
            ...
            if (t.centeredSlides) {
              for (
                ...
                n[c] &&
                  !o &&
                  ((s += 1), (l += n[c].swiperSlideSize) > i && (o = !0));
          ...
          if (n.enabled) {
            ...
            if (
              ("container" !== n.params.mousewheel.eventsTarget &&
                (i = g(n.params.mousewheel.eventsTarget)),
        ...
        init: function () {
          ...
          (n.params.navigation = L(
            ...
            (r.nextEl || r.prevEl) &&
              ...
              n.enabled ||
                (e && e.addClass(r.lockClass), t && t.addClass(r.lockClass)));
        },
        destroy: function () {
          var e = this,
            t = e.navigation,
      ...
      ee = {
        update: function () {
          ...
          if (
            ...
            if (
              ("fraction" === n.type &&
                (a.find(A(n.currentClass)).text(n.formatFractionCurrent(r + 1)),
        ...
        updateSize: function () {
          ...
          if (e.params.scrollbar.el && e.scrollbar.el) {
            ...
            (i =
              ...
              E(t, { trackSize: a, divider: s, moveDivider: o, dragSize: i }),
              e.params.watchOverflow &&
                e.enabled &&
            ...
            l &&
              (o.touch
                ? (l.addEventListener(r.start, e.scrollbar.onDragStart, c),
                  ...
                  l.addEventListener(r.end, e.scrollbar.onDragEnd, u))
            ...
            l &&
              (o.touch
                ? (l.removeEventListener(r.start, e.scrollbar.onDragStart, c),
                  ...
                  l.removeEventListener(r.end, e.scrollbar.onDragEnd, u))
        ...
        init: function () {
          ...
          if (r.el) {
            ...
            0 === a.length &&
              ...
              i.append(a)),
              E(t, { $el: i, el: i[0], $dragEl: a, dragEl: a[0] }),
      ...
      re = {
        ...
        onGestureChange: function (e) {
          ...
          if (!n.gestures) {
            ...
            (i.fakeGestureMoved = !0),
              (a.scaleMove = re.getDistanceBetweenTouches(e));
          }
          a.$imageEl && 0 !== a.$imageEl.length
            ? (n.gestures
              ...
              i.scale < r.minRatio &&
                (i.scale =
                  r.minRatio + 1 - Math.pow(r.minRatio - i.scale + 1, 0.5)),
        ...
        in: function (e) {
          ...
          T.$slideEl ||
            (e &&
              e.target &&
              (T.$slideEl = g(e.target).closest("." + b.params.slideClass)),
            T.$slideEl ||
              (b.params.virtual && b.params.virtual.enabled && b.virtual
                ? (T.$slideEl = b.$wrapperEl.children(
          ...
          if (t.enabled) {
            ...
            n.gestures
              ...
              : "touchstart" === e.touchEvents.start &&
                ...
                e.touchEvents.cancel &&
                  e.$wrapperEl.off(e.touchEvents.cancel, a, t.onGestureEnd, r)),
              e.$wrapperEl.off(
                e.touchEvents.move,
                "." + e.params.zoom.containerClass,
                t.onTouchMove,
            ...
            if (o > 1 || (s.loadPrevNextAmount && s.loadPrevNextAmount > 1)) {
              for (
                var d = s.loadPrevNextAmount,
                  p = o,
                  f = Math.min(i + p + Math.max(d, p), r.length),
                  h = Math.max(i - Math.max(p, d), 0),
                  m = i + o;
                m < f;
                m += 1
              )
        ...
        onEnterOrSpaceKey: function (e) {
          if (13 === e.keyCode || 32 === e.keyCode) {
            ...
            t.navigation &&
              ...
              t.pagination &&
                r.is(A(t.params.pagination.bulletClass)) &&
                r[0].click();
          }
        },
        notify: function (e) {
          ...
          if (t)
            for (var i = 0, a = r.slides.length; i < a; i += 1) {
              ...
              if (
                ...
                !s.hasClass(r.params.slideDuplicateClass)
              ) {
                var o = s.index();
                r.slideTo(o, e, n);
              }
      ...
      he = {
        ...
        onThumbClick: function () {
          ...
          if (t) {
            ...
            if (
              !(
                (r && g(r).hasClass(e.params.thumbs.slideThumbActiveClass)) ||
                null == n
              )
            ) {
              var i;
        ...
        },
        {
          ...
          params: {
            a11y: {
              ...
              prevSlideMessage: "Próximo slide",
